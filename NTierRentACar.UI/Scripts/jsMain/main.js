...
(function ($) {
    ...
    jQuery(document).ready(function ($) {
        ...
        $("#slideslow-bg").vegas({
            ...
            slides: [
                {
                    src: '../../Content/assets/img/slider-img/slider-img-11.jpg'
                },
                {
                    src: '../../Content/assets/img/slider-img/slider-img-22.jpg'
                },
                {
                    src: '../../Content/assets/img/slider-img/slider-img-33.jpg'
                },
                {
                    src: '../../Content/assets/img/slider-img/slider-img-44.jpg'
                }
            ]
        }); //Home Page Two Slideshow
